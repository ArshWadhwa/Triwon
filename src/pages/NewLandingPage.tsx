...
const NewLandingPage: React.FC = () => {
      ...
      <nav className="fixed top-0 w-screen z-50 flex justify-center">
        <div className="mt-4 bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/50 px-6 py-1 flex items-center justify-between max-w-6xl mx-4 w-full h-16">
          ...
          <div className="flex items-center space-x-3">
            <img
              className="h-[28px] sm:h-[32px] md:h-[35px] lg:h-[38px] w-auto object-contain transition-all duration-200 hover:scale-105"
              src="autofy_logo.png"
              alt="Autofy Logo"
            />
  ...
  to="/signup"
  className="
    bg-gradient-to-r from-blue-500 via-indigo-500 to-teal-400 text-white 
    ...
    text-xs sm:text-base   /* smaller text on iPhone SE */
    px-3 sm:px-5           /* reduce horizontal padding */
    py-1.5 sm:py-2         /* reduce vertical padding */
  "
>
              ...
              <div className="absolute top-full left-4 right-4 mt-2 bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 py-4 md:hidden">
                <div className="flex flex-col space-y-1 px-4">
                  ...
                  <div className="border-t border-gray-200/50 pt-4 mt-4 space-y-2">
                    ...
                    <Link
                      to="/signup"
                      className="block bg-gradient-to-r from-blue-500 via-indigo-500 to-teal-400 text-white px-4 py-2 rounded-lg hover:from-violet-600 hover:to-purple-700 transition-all duration-300 font-semibold text-center"
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
                      Get Started Free
                    </Link>
      ...
      >
        ...
        <div className="relative z-20 px-4 sm:px-6 lg:px-8 w-full max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-4xl xl:max-w-5xl mx-auto text-center md:text-left md:mx-0 md:absolute md:top-[15%] md:left-16 lg:left-20 xl:left-24 hero-text">
          <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold leading-tight text-gray-900 mb-4 md:mb-6">
            ...
            <span className="bg-gradient-to-r from-blue-500 via-indigo-500 to-teal-400 bg-clip-text text-transparent">
  Effortlessly
</span>
          </h1>
          ...
          <div className="transform transition-all duration-1000" style={{ transform: get3DTransform(0.1) }}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start sm:space-x-4 space-y-3 sm:space-y-0 hero-buttons">
              <Link
                to="/signup"
                className="group bg-gradient-to-r from-blue-500 via-indigo-500 to-teal-400 text-white px-6 py-3 rounded-xl font-semibold text-base hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center space-x-2 w-full sm:w-auto justify-center"
